 ...
 * @author kichi
 */
@WebServlet(name = "ShowSavedRecipeListController", urlPatterns = {"/savedrecipe"})
public class ShowSavedRecipeListController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ShowSavedRecipeListController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
