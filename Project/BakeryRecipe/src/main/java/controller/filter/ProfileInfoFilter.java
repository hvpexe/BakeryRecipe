 ...
 * @author Admin
 */
@WebFilter(filterName = "ProfileInfoFilter", urlPatterns = {"/profileinfo/*"},
        dispatcherTypes = {DispatcherType.FORWARD})
public class ProfileInfoFilter implements Filter {
    ...
    public ProfileInfoFilter () {
    }    
    
    private void doBeforeProcessing (RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug)
            log("ProfileInfoFilter:DoBeforeProcessing");
    ...
    private void doAfterProcessing (RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug)
            log("ProfileInfoFilter:DoAfterProcessing");
    ...
    public void doFilter (ServletRequest request, ServletResponse response,
        ...
        if (debug)
            log("ProfileInfoFilter:doFilter()");
        ...
        try {
            System.out.println("do profileInfo Filter ");
    ...
    public void init (FilterConfig filterConfig) {        
        ...
        if (filterConfig != null)
            if (debug)                
                log("ProfileInfoFilter: Initializing filter");
    }
    ...
    public String toString () {
        if (filterConfig == null)
            return ("ProfileInfoFilter()");
        StringBuffer sb = new StringBuffer("ProfileInfoFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter (String name, String[] values) {
            if (debug)
                System.out.
                        println("ProfileInfoFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
        ...
        public String getParameter (String name) {
            if (debug)
                System.out.println("ProfileInfoFilter::getParameter(" + name + ") localParams = " + localParams);
            if (localParams == null)
        ...
        public String[] getParameterValues (String name) {
            if (debug)
                System.out.println("ProfileInfoFilter::getParameterValues(" + name + ") localParams = " + localParams);
            if (localParams == null)
        ...
        public Enumeration getParameterNames () {
            if (debug)
                System.out.println("ProfileInfoFilter::getParameterNames() localParams = " + localParams);
            if (localParams == null)
        ...
        public Map getParameterMap () {
            if (debug)
                System.out.println("ProfileInfoFilter::getParameterMap() localParams = " + localParams);
            if (localParams == null)
