...
public class Recipe {
    ...
    public Recipe(int recipeID, String name, String description, int like, int save, int comment, Timestamp timestamp, Timestamp timestamp0, int prepTime, int cookTime, int userID) {
         this.id = id;
        this.name = name;
        this.description = description;
        this.like = like;
