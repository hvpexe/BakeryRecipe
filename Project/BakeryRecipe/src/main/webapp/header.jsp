<header class="header-container container-fluid px-0">
    <header class="header px-0 m-0">
        ...
        <div class="header-right col-sm-12 col-md p-0 justify-content-md-center">
            <div class="searchbar col-md-8 col p-0">
                <div class="searchbar-div col-11">
                    <img class="searchbar-icon " alt="" src="assets/public/searchbaricon.svg"><input class="searchbar-input col p-0" type="text" placeholder="Search" name="searchbar">
                </div>
            </div>
            <div class="group-div col-md col-12 d-md-none d-flex p-0 py-2 justify-content-around">
                <a class="header-button col-5 btn active" data-type="login"><div class="col">Login</div></a>
                <a class="header-button col-5 btn " data-type="register"><div class="col">Signup</div></a>
            </div>
        </div>
    </header>
