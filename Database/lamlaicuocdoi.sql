CREATE TABLE Comment (ID int IDENTITY(0, 0) NOT NULL, Comment nvarchar(500) NOT NULL, Rate bit NOT NULL, DateComment datetime NOT NULL, LastDateEdit datetime NULL, IsDeleted bit NOT NULL, UserID int NOT NULL, RecipeID int NOT NULL, CONSTRAINT PK__Comments__C3B4DFAABAE3DA4F PRIMARY KEY (ID));
CREATE TABLE Follow (UserID int NOT NULL, UserID2 int NOT NULL, PRIMARY KEY (UserID, UserID2));
CREATE TABLE Ingredient (ID int IDENTITY(0, 0) NOT NULL, Name nvarchar(50) NOT NULL, Img varchar(100) NOT NULL, CONSTRAINT PK_Ingredient PRIMARY KEY (ID));
CREATE TABLE IngredientRecipe (IngredientID int NOT NULL, RecipeID int NOT NULL, PRIMARY KEY (IngredientID, RecipeID));
CREATE TABLE Instruction (ID int IDENTITY(0, 0) NOT NULL, InsStep int NOT NULL, Detail text NOT NULL, Img varchar(100) NULL, CONSTRAINT PK_Instruction PRIMARY KEY (ID));
CREATE TABLE InstructionRecipe (InstructionID int NOT NULL, RecipeID int NOT NULL, PRIMARY KEY (InstructionID, RecipeID));
CREATE TABLE Picture (ID int IDENTITY(0, 0) NOT NULL, img varchar(100) NOT NULL, RecipeID int NOT NULL, CONSTRAINT PK_PostImg PRIMARY KEY (ID));
CREATE TABLE Product (ID int IDENTITY(0, 0) NOT NULL, Name nvarchar(50) NOT NULL, Price int NOT NULL, Quantity int NOT NULL, Detail text NULL, img varchar(100) NOT NULL, type nvarchar(50) NOT NULL, IsDeleted bit NOT NULL, IngredientID int NULL, StoreID int NOT NULL, CONSTRAINT PK__Products__B40CC6ED11F92BC5 PRIMARY KEY (ID));
...
CREATE TABLE Store (ID int IDENTITY(0, 0) NOT NULL, Name nvarchar(50) NOT NULL, DateRegister date NOT NULL, Logo varchar(100) NOT NULL, Address nvarchar(100) NOT NULL, Email varchar(100) NOT NULL, Phone varchar(15) NOT NULL, IsActive bit NOT NULL, UserID int NOT NULL, CONSTRAINT PK_Stores PRIMARY KEY (ID));
CREATE TABLE [User] (ID int IDENTITY(0, 0) NOT NULL, Role nvarchar(10) NOT NULL, Email varchar(100) NOT NULL, Password varchar(50) NOT NULL, Avatar varchar(100) NOT NULL, FirstName nvarchar(50) NOT NULL, LastName nvarchar(50) NOT NULL, Gender nvarchar(10) NOT NULL, Phone varchar(15) NULL, Address nvarchar(100) NULL, DateRegister date NOT NULL, IsActive bit NOT NULL, StoreID int NULL, CONSTRAINT PK__Users__1788CCAC6665F995 PRIMARY KEY (ID), CONSTRAINT UQ__Users__A9D10534B9A735C3 UNIQUE (Email));
