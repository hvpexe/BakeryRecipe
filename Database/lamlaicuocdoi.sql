...
CREATE TABLE [User] (ID int IDENTITY(1, 1) NOT NULL, Role nvarchar(10) NOT NULL, Email varchar(100) NOT NULL, Password varchar(50) NOT NULL, Avatar varchar(100) NOT NULL, FirstName nvarchar(50) NOT NULL, LastName nvarchar(50) NOT NULL, Gender nvarchar(10) NOT NULL, Phone varchar(15) NULL, Address nvarchar(100) NULL, DateRegister date NOT NULL, IsActive bit NOT NULL, StoreID int NULL, CONSTRAINT PK__Users__1788CCAC6665F995 PRIMARY KEY (ID), CONSTRAINT UQ__Users__A9D10534B9A735C3 UNIQUE (Email));
